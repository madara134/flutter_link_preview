...
class WebAnalyzer {
  ...
  static InfoBase? _analyzeGif(html.Document document, Uri uri) {
  ...
  static InfoBase? _analyzeVideo(html.Document document, Uri uri) {
  ...
  static String? _getMetaContent(
      html.Document document, String property, String propertyValue) {
    final List<html.Element?> meta =
  ...
  static String _analyzeTitle(html.Document document) {
  ...
  static String? _analyzeDescription(html.Document document, String html) {
  ...
  static String? _analyzeIcon(html.Document document, Uri uri) {
    final List<html.Element?> meta =
  ...
  static String? _analyzeImage(html.Document document, Uri uri) {
